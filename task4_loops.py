...
#task 4
for names_and_sales in video_game_sales:
    copies_sold = names_and_sales[GLOBAL_SALES] 
    names = names_and_sales[NAME]
    if copies_sold >25:
        print(names, copies_sold)#part A

pre_2000_count = 0
for game in video_game_sales:
    if game[YEAR] <2000:
        pre_2000_count = pre_2000_count + 1
print(pre_2000_count)#part B 

total_NA_sales = 0
total_JA_sales = 0 
for game in video_game_sales:
     total_JA_sales = game[JP_SALES] + total_JA_sales
     total_NA_sales = game[NA_SALES] + total_NA_sales
if total_JA_sales > total_NA_sales:
    higher_sales = 'Japan'
else:
